...
module SymbExpr : sig
  ...
  val incomplete : t
  val fallback : t
  val mk_incomplete_or_fallback : t -> t
  val mk_incomplete_or_fallback_list : t list -> t
  val propagate_incomplete_fallback_list : t list -> (t list -> t) -> t
  val apply_fallback : t -> t -> t
